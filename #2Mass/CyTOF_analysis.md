...
al.2020. There are 7 samples of PBMC from human. Treated samples are
coated with Ag nano pariticle in various method.We use a leukocyte
sample which are manually gated and concatenated in FlowJo Software.  
